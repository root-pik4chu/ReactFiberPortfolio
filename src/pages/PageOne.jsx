...
export default function PageOne(props) {
  ...
  return (
    <div style={{height:'100vh'}} className="app w-full h-[80vh] absolute top-0 left-0">
      <Canvas flat shadows onClick={click} dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 30], fov: 17.5, near: 2, far: 50 }} {...props}>
